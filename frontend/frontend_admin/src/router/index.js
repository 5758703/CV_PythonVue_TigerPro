...
const routes = [
  ...
  { path: '/register', name: 'register', component: () => import('../views/Register.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      {
        path: 'ai/scenarios/efficient-sam',
        name: 'aiScenarioEfficientSam',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'efficient-sam' },
        meta: { title: 'EfficientSAM 场景', modelKey: 'efficient-sam' },
      },
      {
        path: 'ai/scenarios/mobile-sam',
        name: 'aiScenarioMobileSam',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'mobile-sam' },
        meta: { title: 'MobileSAM 场景', modelKey: 'mobile-sam' },
      },
      {
        path: 'ai/scenarios/clip-reid-vehicle',
        name: 'aiScenarioClipReidVehicle',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'clip-reid-vehicle' },
        meta: { title: 'CLIP-ReID Vehicle 场景', modelKey: 'clip-reid-vehicle' },
      },
      {
        path: 'ai/scenarios/keremberke-yolov5m-license-plate',
        name: 'aiScenarioYolov5mLicensePlate',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'keremberke-yolov5m-license-plate' },
        meta: { title: 'YOLOv5m 车牌场景', modelKey: 'keremberke-yolov5m-license-plate' },
      },
      {
        path: 'ai/scenarios/keremberke-yolov5n-license-plate',
        name: 'aiScenarioYolov5nLicensePlate',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'keremberke-yolov5n-license-plate' },
        meta: { title: 'YOLOv5n 车牌场景', modelKey: 'keremberke-yolov5n-license-plate' },
      },
      {
        path: 'ai/scenarios/transreid-vehicle',
        name: 'aiScenarioTransReidVehicle',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'transreid-vehicle' },
        meta: { title: 'TransReID Vehicle 场景', modelKey: 'transreid-vehicle' },
      },
      {
        path: 'ai/scenarios/vehicle-vit-reid',
        name: 'aiScenarioVehicleVitReid',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'vehicle-vit-reid' },
        meta: { title: 'Vehicle ViT ReID 场景', modelKey: 'vehicle-vit-reid' },
      },
      {
        path: 'ai/scenarios/yolo26n-obb',
        name: 'aiScenarioYolo26nObb',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'yolo26n-obb' },
        meta: { title: 'YOLO26n OBB 场景', modelKey: 'yolo26n-obb' },
      },
      {
        path: 'ai/scenarios/yolo26n-p2-plate',
        name: 'aiScenarioYolo26nP2Plate',
        component: () => import('../views/ai/scenarios/ScenarioApp.vue'),
        props: { modelKey: 'yolo26n-p2-plate' },
        meta: { title: 'YOLO26n-P2 车牌场景', modelKey: 'yolo26n-p2-plate' },
      },
      ...
      { path: 'ai/defect', name: 'aiDefect', component: () => import('../views/ai/defect/index.vue'), meta: { title: '缺陷诊断' } },
      { path: 'ai/pipeline', name: 'aiPipeline', component: () => import('../views/ai/pipeline/index.vue'), meta: { title: '视频分析流水线' } },
      { path: 'ai/pipeline/metrics', name: 'aiPipelineMetrics', component: () => import('../views/ai/pipeline/metrics.vue'), meta: { title: '流水线指标' } },
