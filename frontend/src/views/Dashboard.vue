  ...
  <div class="home">
    ...
    <div class="hero">
      ...
      <div class="hero-body">
        ...
        <p class="hero-desc">一站式管理与在线测试多种 AI 模型：从 <b>HuggingFace / ModelScope（模搭社区）双下载源</b>拉取权重、统一纳管、按任务在对应页面即点即测。 平台现支持 <b>13 类 AI 任务</b>，跨 <b>视觉 / 文本 / 语音 / 多模态</b> 四大方向， 推理引擎涵盖 <b>YOLO · transformers · funasr · onnx 量化 · CosyVoice · VibeVoice</b>，纯 <b>CPU</b> 即可运行 —— 覆盖目标检测、图像分类、文本分类、零样本分类、完形填空、翻译 / 摘要 / 生成、实体识别、智能问答、语音识别、语音合成、数字人合成。</p>
        <div class="hero-tags">
